...
function HeroSearch() {
    ...
    const complexName = () => {
        return (
            <div className="unit-100" id="search_input_complex" >
    ...
    const properties = () => {
        return (
            <div className="unit-100" id="search_input_reference">
            ...
            <div className="search">
                <div className="wrapper units-row">
                    ...
                    <div id="search_card" className="card">
                        ...
                        <ul id="search_forms">
                            <li id="search_location" onClick={setLocation} className="selected">Location</li>
                    ...
                    <form name="frmSearch" onSubmit={handleSubmit} >
